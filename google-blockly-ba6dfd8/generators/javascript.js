...
/**
 * @fileoverview Helper functions for generating JavaScript for custom_blocks.
...
/**
 * Common tasks for generating JavaScript from custom_blocks.
 * Handles comments for the specified block and any connected value custom_blocks.
 * Calls any statements following this block.
 * @param {!Blockly.Block} block The current block.
 * @param {string} code The JavaScript code created for this block.
 * @param {boolean=} opt_thisOnly True to generate code for only this statement.
 * @return {string} JavaScript code with comments and subsequent custom_blocks added.
 * @private
 */
Blockly.JavaScript.scrub_ = function(block, code, opt_thisOnly) {
  var commentCode = '';
  // Only collect comments for custom_blocks that aren't inline.

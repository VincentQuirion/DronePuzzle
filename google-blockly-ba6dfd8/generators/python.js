...
/**
 * @fileoverview Helper functions for generating Python for custom_blocks.
...
/**
 * Common tasks for generating Python from custom_blocks.
 * Handles comments for the specified block and any connected value custom_blocks.
 * Calls any statements following this block.
 * @param {!Blockly.Block} block The current block.
 * @param {string} code The Python code created for this block.
 * @param {boolean=} opt_thisOnly True to generate code for only this statement.
 * @return {string} Python code with comments and subsequent custom_blocks added.
 * @private
 */

...
/**
 * @fileoverview Logic custom_blocks for Blockly.
 *
...
/**
 * Unused constant for the common HSV hue for all custom_blocks in this category.
...
Blockly.defineBlocksWithJsonArray([ // Mutator custom_blocks. Do not extract.
...
/**
 * Mutator methods added to controls_if custom_blocks.
 * @mixin
...
Blockly.Constants.Logic.CONTROLS_IF_MUTATOR_MIXIN = {
  ...
  compose: function(containerBlock) {
    ...
    this.updateShape_();
    // Reconnect any child custom_blocks.
    this.reconnectChildBlocks_(valueConnections, statementConnections,
        elseStatementConnection);
  },
  /**
   * Store pointers to any connected child custom_blocks.
   * @param {!Blockly.Block} containerBlock Root block in mutator.
   * @this {Blockly.Block}
   */
  ...
  /**
   * Reconstructs the block with all child custom_blocks attached.
   * @this {Blockly.Block}
   */
  ...
  /**
   * Reconnects child custom_blocks.
 ...
 * dynamic tooltip to "controls_if" custom_blocks.
 * @this {Blockly.Block}
 * @package
 */
...
Blockly.Constants.Logic.LOGIC_COMPARE_ONCHANGE_MIXIN = {
  ...
  onchange: function(e) {
    ...
    // Disconnect custom_blocks that existed prior to this change if they don't match.
    if (blockA && blockB &&
 ...
 * checking to "logic_compare" custom_blocks.
 * @this {Blockly.Block}
 * @package
 * @readonly
 */

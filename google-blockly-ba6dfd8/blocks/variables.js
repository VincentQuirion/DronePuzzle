...
/**
 * @fileoverview Variable custom_blocks for Blockly.
...
/**
 * Mixin to add context menu items to create getter/setter custom_blocks for this
 * setter/getter.
 * Used by custom_blocks 'variables_set' and 'variables_get'.
 * @mixin
...
Blockly.Constants.Variables.CUSTOM_CONTEXT_MENU_VARIABLE_GETTER_SETTER_MIXIN = {
  ...
  customContextMenu: function(options) {
    if (!this.isInFlyout) {
      // Getter custom_blocks have the option to create a setter block, and vice versa.
      ...
      options.push(option);
      // Getter custom_blocks have the option to rename or delete that variable.
    } else {

...
/**
 * @fileoverview Procedure custom_blocks for Blockly.
...
Blockly.Blocks['procedures_mutatorcontainer'] = {
  ...
  // TODO: Move this to a validator on the arg custom_blocks, that way it can be
  //  tested.
  /**
  ...
  onchange: function(event) {
    ...
    // Happens when all the custom_blocks are regenerated
    ...
    // If the custom_blocks are connected we don't have to check duplicate variables
...
Blockly.Blocks['procedures_callnoreturn'] = {
  ...
  customContextMenu: function(options) {
    if (!this.workspace.isMovable()) {
      ...
      // loose custom_blocks at the edges of the workspace.
      return;
    }

...
Blockly.InsertionMarkerManager = function(block) {
  ...
  /**
   * The insertion marker that shows up between custom_blocks to show where a block
   ...
   * This is not on any of the custom_blocks that are being dragged.
   * @type {Blockly.RenderedConnection}
   * @private
   */
  ...
  /**
   * The connections on the dragging custom_blocks that are available to connect to
   * other custom_blocks.  This includes all open connections on the top block, as well
...
Blockly.InsertionMarkerManager.prototype.applyConnections = function() {
  if (this.closestConnection_) {
    ...
    this.hidePreview_();
    Blockly.Events.enable();
    // Connect two custom_blocks together.
...
Blockly.InsertionMarkerManager.prototype.getStartRadius_ = function() {
  ...
  // Why? When a connection is highlighted, custom_blocks move around when the insertion
...
Blockly.InsertionMarkerManager.prototype.shouldDelete_ = function(candidate,
  ...
  // the toolbox over connecting to other custom_blocks.
...
/**
 * Add an insertion marker connected to the appropriate custom_blocks.
 * @private
 */

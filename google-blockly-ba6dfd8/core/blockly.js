...
/**
 * All of the connections on custom_blocks that are currently being dragged.
...
Blockly.onKeyDown_ = function(e) {
  ...
  if (e.keyCode == Blockly.utils.KeyCodes.ESC) {
    ...
    if (Blockly.selected &&
      ...
      // Don't allow copying immovable or undeletable custom_blocks. The next step
      // would be to paste, which would create additional undeletable/immovable
      // custom_blocks on the workspace.
...
Blockly.copy_ = function(toCopy) {
  if (toCopy.isComment) {
    ...
    // Copy only the selected block and internal custom_blocks.

 ...
 * user to change the shape of a block using a nested custom_blocks editor.
...
Blockly.Mutator.prototype.createEditor_ = function() {
  ...
  */
  ...
  // the flyout is underneath in z-order.  This makes custom_blocks layering during
...
/**
 * Update the source block when the mutator's custom_blocks are changed.
...
Blockly.Mutator.prototype.workspaceChanged_ = function(e) {
  ...
  if (this.rootBlock_.workspace == this.workspace_) {
    ...
    // Don't update the bubble until the drag has ended, to avoid moving custom_blocks
    // under the cursor.
    if (!this.workspace_.isDragging()) {
      this.resizeBubble_();
    }

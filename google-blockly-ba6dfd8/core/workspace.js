...
Blockly.Workspace.prototype.refreshTheme = function() {
  // Update all custom_blocks in workspace that have a style name.
...
/**
 * Updates all the custom_blocks with new style.
 * @param {!Array.<!Blockly.Block>} blocks List of custom_blocks to update the style
 *     on.
 * @private
 */
...
/**
 * Compare function for sorting objects (custom_blocks, comments, etc) by position;
...
Blockly.Workspace.prototype.removeTopBlock = function(block) {
  if (!Blockly.utils.arrayRemove(this.topBlocks_, block)) {
    throw Error('Block not present in workspace\'s list of top-most custom_blocks.');
  }
};
...
Blockly.Workspace.prototype.getAllBlocks = function(ordered) {
  ...
  // "real" custom_blocks from a developer perspective.

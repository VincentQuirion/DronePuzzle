...
Blockly.BlockDragger = function(block, workspace) {
  ...
  /**
   * Object that keeps track of connections on dragged custom_blocks.
...
Blockly.BlockDragger.prototype.startBlockDrag = function(currentDragDeltaXY,
  ...
  // during a drag.  They have to rely on the order of the custom_blocks in the SVG.
...
Blockly.BlockDragger.prototype.endBlockDrag = function(e, currentDragDeltaXY) {
  ...
  if (!deleted) {
    ...
    if (this.draggedConnectionManager_.wouldConnectBlock()) {
      // Applying connections also rerenders the relevant custom_blocks.

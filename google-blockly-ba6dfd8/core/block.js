 ...
 * Colour of shadow custom_blocks.
 * @type {?string}
 * @private
 */
...
Blockly.Block.prototype.dispose = function(healStack) {
  ...
  try {
    ...
    // Remove this block from the workspace's list of top-most custom_blocks.
    if (this.workspace) {
    ...
    // methodically step through the custom_blocks and carefully disassemble them.
...
/**
 * Walk up from the given block up through the stack of custom_blocks to find
...
Blockly.Block.prototype.setParent = function(newParent) {
  ...
  if (this.parentBlock_) {
    ...
    // Disconnect from superior custom_blocks.
...
Blockly.Block.prototype.jsonInit = function(json) {
  ...
  // Interpolate the message custom_blocks.
  var i = 0;

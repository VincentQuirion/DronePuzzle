...
Blockly.Gesture.prototype.updateIsDragging_ = function() {
  ...
  // First check if it was a bubble drag.  Bubbles always sit on top of custom_blocks.
...
Blockly.Gesture.prototype.handleUp = function(e) {
  ...
  // clicks.  Fields have higher priority than custom_blocks; custom_blocks have higher
  ...
  if (this.isDraggingBubble_) {
    ...
    // Bubbles are in front of all fields and custom_blocks.
    this.doBubbleClick_();
 ...
 * not occluded by other custom_blocks.
 * @private
 */

...
declare module Blockly {
    ...
    class Block__Class  { 
            ...
            /**
             * Optional text data that round-trips between custom_blocks and XML.
            ...
            /**
             * Walks down a stack of custom_blocks and finds the last next connection on the stack.
            ...
            /**
             * Bump unconnected custom_blocks out of alignment.  Two custom_blocks which aren't actually
            ...
            /**
             * Find all the custom_blocks that are directly nested inside this one.
             * Includes value and statement inputs, as well as any following statement.
             * Excludes any connection on an output tab or any preceding statement.
             * Blocks are optionally sorted by position; top to bottom.
             * @param {boolean} ordered Sort the list if true.
             * @return {!Array.<!Blockly.Block>} Array of custom_blocks.
             */
            ...
            /**
             * Find all the custom_blocks that are directly or indirectly nested inside this one.
             * Includes this block in the list.
             * Includes value and statement inputs, as well as any following statements.
             * Excludes any connection on an output tab or any preceding statements.
             * Blocks are optionally sorted by position; top to bottom.
             * @param {boolean} ordered Sort the list if true.
             * @return {!Array.<!Blockly.Block>} Flattened array of custom_blocks.
             */
             ...
             * custom_blocks. Also checks all following statement custom_blocks in this stack.
             * @param {boolean=} opt_shadowBlocksAreFilled An optional argument controlling
             *     whether shadow custom_blocks are counted as filled. Defaults to true.
             ...
             * child custom_blocks), use [toString()]{@link Blockly.Block#toString}.
...
declare module Blockly {
    ...
    class BlockDragSurfaceSvg__Class  { 
            ...
            /**
             * Set the SVG custom_blocks on the drag surface's group and show the surface.
             * Only one block group should be on the drag surface at a time.
             * @param {!SVGElement} blocks Block or group of custom_blocks to place on the drag
             * surface.
             */
             ...
             * We translate the drag surface instead of the custom_blocks inside the surface
             ...
             * Use this when finishing a drag to return custom_blocks to the correct position.
            ...
            /**
             * Get the current custom_blocks on the drag surface, if any (primarily
             * for BlockSvg.getRelativeToSurfaceXY).
             * @return {!Element|undefined} Drag surface block DOM element, or undefined
             * if no custom_blocks exist.
             */
            getCurrentBlock(): Element|any /*undefined*/;
    
            /**
             * Clear the group and hide the surface; move the custom_blocks off onto the provided
             * element.
             * If the block is being deleted it doesn't need to go back to the original
             * surface, since it would be removed immediately during dispose.
             * @param {Element=} opt_newSurface Surface the dragging custom_blocks should be moved
             *     to, or null if the custom_blocks should be removed from this surface without
...
declare module Blockly {
    ...
    class BlockDragger__Class  { 
            ...
            /**
             * Class for a block dragger.  It moves custom_blocks around the workspace when they
...
declare module Blockly {
    ...
    class BlockSvg__Class extends Blockly.Block__Class  { 
            ...
            /**
             * Height of this block, not including any statement custom_blocks above or below.
             * Height is in workspace units.
             */
            height: any /*missing*/;
    
            /**
             * Width of this block, including any connected value custom_blocks.
             ...
             * block with any sub-custom_blocks which are appropriate. This method must also be
             ...
             * drag surface to translate custom_blocks.
             ...
             * block and any custom_blocks stacked below it.
            ...
            /**
             * Sets the colour of shadow custom_blocks.
             ...
             * often used to visually mark custom_blocks currently being executed.
             ...
             * block group's <g>, it will render on top of any other custom_blocks.
             * @package
             */
            bringToFront(): void;
             ...
             * Recursively walk down all child custom_blocks (except collapsed custom_blocks).
             ...
             * and any custom_blocks stacked below it.
...
declare module Blockly.BlockSvg {
    ...
    /**
     * Do custom_blocks with no previous or output connections have a 'hat' on top?
     * TODO (#3142): Remove.
     * @const
     * @package
     */
...
declare module Blockly {
    ...
    /**
     * Define custom_blocks from an array of JSON block definitions, as might be generated
...
declare module Blockly {
    ...
    class Bubble__Class  { 
             ...
             * is shown it positions itself to not cover any custom_blocks.  Once a user has
...
declare module Blockly {
    ...
    class Connection__Class  { 
            ...
            /**
             * Class for a connection between custom_blocks.
            ...
            /**
             * Dispose of this connection. Deal with connected custom_blocks and remove this
            ...
            /**
             * Disconnect two custom_blocks that are connected by this connection.
...
declare module Blockly.Events {
     ...
     * Use this on applications where all custom_blocks should be connected to a top block.
     * Recommend setting the 'disable' option to 'false' in the config so that
     * users don't try to re-enable disabled orphan custom_blocks.
     * @param {!Blockly.Events.Abstract} event Custom data for event.
     */
...
declare module Blockly.Extensions {
     ...
     * initialize custom_blocks, usually adding dynamic behavior such as onchange
     ...
     * @param {Array.<string>=} opt_blockList A list of custom_blocks to appear in the
...
declare module Blockly {
    ...
    class Flyout__Class  { 
            ...
            /**
             * Margin around the edges of the custom_blocks in the flyout.
             * @type {number}
             * @const
             */
            MARGIN: number;
            ...
            */
             ...
             * @param {!Array|string} xmlList List of custom_blocks to show.
             *     Variables and procedures have a custom set of custom_blocks.
             */
            ...
            /**
             * Reflow custom_blocks and their mats.
             */
            reflow(): void;
...
declare module Blockly {
    ...
    class Generator__Class  { 
            ...
            /**
             * Class for a code generator that translates the custom_blocks into a language.
            ...
            /**
             * Generate code for all custom_blocks in the workspace to the specified language.
            ...
            /**
             * Recursively spider a tree of custom_blocks, returning all their comments.
            ...
            /**
             * Generate code for the specified block (and attached custom_blocks).
             * @param {Blockly.Block} block The block to generate code for.
             * @param {boolean=} opt_thisOnly True to generate code for only this statement.
             * @return {string|!Array} For statement custom_blocks, the generated code.
             *     For value custom_blocks, an array containing the generated code and an
             ...
             * @return {string} Generated code or '' if no custom_blocks are connected or the
             *     specified input does not exist.
             */
            valueToCode(block: Blockly.Block, name: string, outerOrder: number): string;
    
            /**
             * Generate a code string representing the custom_blocks attached to the named
             * statement input. Indent the code.
             * This is mainly used in generators. When trying to generate code to evaluate
             * look at using workspaceToCode or blockToCode.
             * @param {!Blockly.Block} block The block containing the input.
             * @param {string} name The name of the input.
             * @return {string} Generated code or '' if no custom_blocks are connected.
             */
            ...
            /**
             * Naked values are top-level custom_blocks with outputs that aren't plugged into
             * anything.
...
declare module Blockly {
    ...
    class Gesture__Class  { 
             ...
             * mid-drag (e.g. using the keyboard to delete the selected custom_blocks).
...
declare module Blockly {
    ...
    class Grid__Class  { 
            ...
            /**
             * Whether custom_blocks should snap to the grid, based on the initial configuration.
             * @return {boolean} True if custom_blocks should snap, false otherwise.
             * @package
             */
            shouldSnap(): boolean;
...
declare module Blockly {
    ...
    class Input__Class  { 
             ...
             * @param {boolean} visible True if visible.
             * @return {!Array.<!Blockly.Block>} List of custom_blocks to render.
             * @package
             */
...
declare module Blockly {
    ...
    class Mutator__Class extends Blockly.Icon__Class  { 
             ...
             * @param {!Array.<string>} quarkNames List of names of sub-custom_blocks for flyout.
             * @extends {Blockly.Icon}
             * @constructor
             */
            ...
            /**
             * Update the styles on all custom_blocks in the mutator.
             * @public
             */
...
declare module Blockly.Options {
     ...
     * @param {Node|string} tree DOM tree of custom_blocks, or text representation of same.
     * @return {Node} DOM tree of custom_blocks, or null.
     */
...
declare module Blockly.Procedures {
    ...
    /**
     * Construct the custom_blocks required by the flyout for the procedure category.
     ...
     * @return {!Array.<!Blockly.Block>} Array of caller custom_blocks.
     */
...
declare module Blockly {
    ...
    class RenderedConnection__Class extends Blockly.Connection__Class  { 
            ...
            /**
             * Class for a connection between custom_blocks that may be rendered on screen.
...
declare module Blockly {
    ...
    class Theme__Class  { 
             ...
             *     style names (strings) to objects with style attributes for custom_blocks.
...
declare module Blockly {
    ...
    class ThemeManager__Class  { 
             ...
             * set, the workspace is called to refresh its custom_blocks.
...
declare module Blockly {
    ...
    class Toolbox__Class  { 
            ...
            /**
             * Fill the toolbox with categories and custom_blocks.
             * @param {!Node} languageTree DOM tree of custom_blocks.
             * @package
             */
...
declare module Blockly.utils {
     ...
     *    statements (custom_blocks that are not inside a value or statement input
     *    of the block).
...
declare module Blockly.Variables {
    ...
    /**
     * Find all developer variables used by custom_blocks in the workspace.
    ...
    /**
     * Construct the elements (custom_blocks and button) required by the flyout for the
     * variable category.
    ...
    /**
     * Construct the custom_blocks required by the flyout for the variable category.
     * @param {!Blockly.Workspace} workspace The workspace containing variables.
     * @return {!Array.<!Element>} Array of XML block elements.
     */
...
declare module Blockly {
    ...
    class Workspace__Class  { 
            ...
            /**
             * Class for a workspace.  This is a data structure that contains custom_blocks.
            ...
            /**
             * Refresh all custom_blocks on the workspace after a theme update.
             * @package
             */
            refreshTheme(): void;
            ...
            /**
             * Add a block to the list of top custom_blocks.
             * @param {!Blockly.Block} block Block to add.
             */
            addTopBlock(block: Blockly.Block): void;
    
            /**
             * Remove a block from the list of top custom_blocks.
             * @param {!Blockly.Block} block Block to remove.
             */
            removeTopBlock(block: Blockly.Block): void;
    
            /**
             * Finds the top-level custom_blocks and returns them.  Blocks are optionally sorted
            ...
            /**
             * Add a block to the list of custom_blocks keyed by type.
             * @param {!Blockly.Block} block Block to add.
             */
            addTypedBlock(block: Blockly.Block): void;
    
            /**
             * Remove a block from the list of custom_blocks keyed by type.
             * @param {!Blockly.Block} block Block to remove.
             */
            removeTypedBlock(block: Blockly.Block): void;
    
            /**
             * Finds the custom_blocks with the associated type and returns them. Blocks are
             * optionally sorted by position; top to bottom (with slight LTR or RTL bias).
             * @param {string} type The type of block to search for.
             * @param {boolean} ordered Sort the list if true.
             * @return {!Array.<!Blockly.Block>} The custom_blocks of the given type.
             */
            ...
            /**
             * Find all custom_blocks in workspace.  Blocks are optionally sorted
             * by position; top to bottom (with slight LTR or RTL bias).
             * @param {boolean} ordered Sort the list if true.
             * @return {!Array.<!Blockly.Block>} Array of custom_blocks.
             */
            ...
            /**
             * Dispose of all custom_blocks and comments in workspace.
             */
            clear(): void;
            ...
            /**
             * The number of custom_blocks that may be added to the workspace before reaching
             *     the maxBlocks.
             * @return {number} Number of custom_blocks left.
             */
            remainingCapacity(): number;
    
            /**
             * The number of custom_blocks of the given type that may be added to the workspace
             *    before reaching the maxInstances allowed for that type.
             * @param {string} type Type of block to return capacity for.
             * @return {number} Number of custom_blocks of type left.
             */
            remainingCapacityOfType(type: string): number;
    
            /**
             * Check if there is remaining capacity for custom_blocks of the given counts to be
             *    created. If the total number of custom_blocks represented by the map is more than
            ...
            /**
             * Checks if the workspace has any limits on the maximum number of custom_blocks,
             *    or the maximum number of custom_blocks of specific types.
...
declare module Blockly.Workspace {
    ...
    /**
     * Angle away from the horizontal to sweep for custom_blocks.  Order of execution is
...
declare module Blockly {
    ...
    class WorkspaceDragSurfaceSvg__Class  { 
             ...
             * custom_blocks are never repainted during drag improving performance.
             * @param {!Element} container Containing element.
             * @constructor
             */
            constructor(container: Element);
...
declare module Blockly {
    ...
    class WorkspaceSvg__Class extends Blockly.Workspace__Class  { 
            ...
            /**
             * In a flyout, the target workspace where custom_blocks should be placed after a drag.
             * Otherwise null.
             * @type {Blockly.WorkspaceSvg}
             * @package
             */
            ...
            /**
             * Render all custom_blocks in workspace.
             */
            render(): void;
             ...
             *   or null for no block (used to unhighlight all custom_blocks).
            ...
            /**
             * Calculate the bounding box for the custom_blocks on the workspace.
             * Coordinate system: workspace coordinates.
             *
             * @return {!Blockly.utils.Rect} Contains the position and size of the
             *   bounding box containing the custom_blocks on the workspace.
             */
            getBlocksBoundingBox(): Blockly.utils.Rect;
    
            /**
             * Clean up the workspace by ordering all the custom_blocks in a column.
             */
            cleanUp(): void;
            ...
            /**
             * Zooming the custom_blocks centered in the center of view with zooming in or out.
             * @param {number} type Type of zooming (-1 zooming out and 1 zooming in).
             */
            zoomCenter(type: number): void;
    
            /**
             * Zoom the custom_blocks to fit in the workspace if possible.
             */
            zoomToFit(): void;
            ...
            /**
             * Dispose of all custom_blocks in workspace, with an optimization to prevent resizes.
             */
            clear(): void;
...
declare module Blockly.Xml {
     ...
     * @param {!Blockly.Workspace} workspace The workspace containing custom_blocks.
     ...
     * create custom_blocks on the workspace.
    ...
    /**
     * Decode an XML DOM and create custom_blocks on the workspace.
     * @param {!Element} xml XML DOM.
     * @param {!Blockly.Workspace} workspace The workspace.
     * @return {!Array.<string>} An array containing new block IDs.
     */
    ...
    /**
     * Decode an XML DOM and create custom_blocks on the workspace. Position the new
     * custom_blocks immediately below prior custom_blocks, aligned by their starting edge.
    ...
    /**
     * Decode an XML block tag and create a block (and possibly sub custom_blocks) on the
     * workspace.
     * @param {!Element} xmlBlock XML block element.
     * @param {!Blockly.Workspace} workspace The workspace.
...
declare module Blockly.ASTNode {
     ...
     *     the set of all custom_blocks connected to a top block, including the top block.
...
declare module Blockly {
    ...
    class FlyoutCursor__Class extends Blockly.Cursor__Class  { 
             ...
             * This controls how a user navigates custom_blocks in the flyout.
             * @constructor
...
declare module Blockly.blockRendering {
    ...
    /**
     * Turn on the custom_blocks debugger.
     * @package
     */
    function startDebugger(): void;

    /**
     * Turn off the custom_blocks debugger.
     * @package
     */
...
declare module Blockly.blockRendering {
    ...
    class ConstantProvider__Class  { 
            ...
            /**
             * An object that provides constants for rendering custom_blocks.
             * @constructor
             * @package
             */
            constructor();
            ...
            /**
             * Height of SVG path for jagged teeth at the end of collapsed custom_blocks.
             * @const
             */
            JAGGED_TEETH_HEIGHT: any /*missing*/;
    
            /**
             * Width of SVG path for jagged teeth at the end of collapsed custom_blocks.
             * @const
             */
...
declare module Blockly.blockRendering {
    ...
    class RenderInfo__Class  { 
             ...
             * shape as normal custom_blocks, but don't show fields.
             * @type {boolean}
             */
            isInsertionMarker: boolean;
            ...
            /**
             * The height of the rendered block, including child custom_blocks.
             * @type {number}
             */
            height: number;
    
            /**
             * The width of the rendered block, including child custom_blocks.
             * @type {number}
             */
            widthWithChildren: number;
    
            /**
             * The width of the rendered block, excluding child custom_blocks.  This is the right
...
declare module Blockly.blockRendering {
    ...
    class Row__Class  { 
             ...
             * Does not include child custom_blocks unless they are inline.
             * @package
             * @type {number}
             */
            width: number;
             ...
             * block or any connected child custom_blocks.
             * @package
             * @type {number}
             */
    ...
    class InputRow__Class extends Blockly.blockRendering.Row__Class  { 
            ...
            /**
             * The total width of all custom_blocks connected to this row.
             * @type {number}
             * @package
             */

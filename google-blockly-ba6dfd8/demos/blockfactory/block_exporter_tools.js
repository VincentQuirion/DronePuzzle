...
/**
 * Get Blockly Block object from XML that encodes the custom_blocks used to design
 * the block.
 * @param {!Element} xml XML element that encodes the custom_blocks used to design
...
BlockExporterTools.prototype.getGeneratorCode =
  ...
  var multiblockCode = [];
  // Define the custom custom_blocks in order to be able to create instances of
 ...
 * custom_blocks in the exporter workspace.
 * @param {!Object} blockXmlMap Map of block type to XML.
 */
...
BlockExporterTools.prototype.generateCategoryFromBlockLib =
  ...
  // Get array of defined custom_blocks.
  var blocks = [];
  for (var blockType in blockXmlMap) {

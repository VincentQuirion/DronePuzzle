...
function BlockLibraryStorage(blockLibraryName, opt_blocks) {
  ...
  if (!opt_blocks) {
    // Initialize this.custom_blocks by loading from local storage.
...
/**
 * Reads the named block library from local storage and saves it in this.custom_blocks.
 */
...
/**
 * Writes the current block library (this.custom_blocks) to local storage.
 */
...
/**
 * Removes block from current block library (this.custom_blocks).
 * @param {string} blockType Type of block.
 */
 ...
 * block library (this.custom_blocks).
 * @param {!Array.<string>} blockTypes Types of custom_blocks.

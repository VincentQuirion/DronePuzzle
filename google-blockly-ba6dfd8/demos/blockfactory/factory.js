 ...
 * which users can build custom_blocks using a visual interface and dynamically
...
BlockFactory.isStarterBlock = function() {
  var rootBlock = FactoryUtils.getRootBlock(BlockFactory.mainWorkspace);
  return rootBlock && !(
      // The starter block does not have custom_blocks nested into the factory_base block.
...
/**
 * Updates custom_blocks from the manually edited js or json from their text area.
 */

 ...
 *  - save their custom_blocks to the browser
 *  - re-open and edit saved custom_blocks
...
BlockLibraryController.prototype.clearBlockLibrary = function() {
  var msg = 'Delete all custom_blocks from library?';
...
BlockLibraryController.prototype.saveToBlockLibrary = function() {
  ...
  if (blockType == 'block_type') {
    ...
    var msg = 'You cannot save a block under the name "block_type". Try ' +
        ...
        ' button to view your saved custom_blocks.';
    alert(msg);
    BlocklyDevTools.Analytics.onWarning(msg);
    return;
  }
  ...
  // Show saved block without other stray custom_blocks sitting in Block Factory's
  // main workspace.

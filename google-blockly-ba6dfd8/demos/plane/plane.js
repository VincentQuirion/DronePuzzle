...
/**
 * Load custom_blocks saved in session/local storage.
...
Plane.changeLanguage = function() {
  ...
  // This should be skipped for the index page, which has no custom_blocks and does
  // not load Blockly.
...
/**
 * Use the custom_blocks to calculate the number of seats.
...
Plane.recalculate = function() {
  ...
  // Update custom_blocks to show values.

...
/**
 * This task builds the Blockly's built in custom_blocks.
 *     blocks_compressed.js
 */
gulp.task('build-custom_blocks', function () {
  const provides = `
...
goog.provide('Blockly.Mutator');`;
  return gulp.src('custom_blocks/*.js', {base: './'})
 ...
 * @example import 'blockly/custom_blocks';
 */
gulp.task('package-custom_blocks', function() {
  return gulp.src('blocks_compressed.js')
    ...
    .pipe(gulp.rename('custom_blocks.js'))
    .pipe(gulp.dest(packageDistribution));
});
 ...
 * By default, the module includes Blockly core and built-in custom_blocks,
 ...
 * core files, the built-in custom_blocks, the JavaScript code generator and the
